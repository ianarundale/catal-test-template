...
require.def("sampleapp/appui/components/simplevideocomponent",
    ...
    function (Component, Button, Label, HorizontalList, VideoSource, Media, CatalTest) {
        ...
        return Component.extend({
            init: function () {
                ...
                back.addEventListener('select', function(evt) {
                    ...
                    // think about passing args back to update the previous component
                    ...
                    var testId = "testcase-1-4-3";
                    var testScreenSize3 = new CatalTest(testId, "Sample test 3", function(onTestComplete) {
                        onTestComplete(false, "Video did not fire waiting event");
                    });

                    testCases[testId] = testScreenSize3;


                    console.log(testCases);

                    var args = {
                        title : "CATAL Test Case - video tests",
                        userInstructions : "******* Here are some even more ****** instructions for the test",
                        additionalInformation : "Additional information, ensure you are plugged in",
                        testCases : testCases
                    };

                    try {
                        self.getCurrentApplication().showComponent("maincontainer", "sampleapp/appui/components/simple", args);
                    } catch(e) {
                        debugger;
                    }
